...
const PRECACHE = [
  ...
  "./assets/js/members-data.js?v=44",
  "./assets/js/news-data.js?v=44",
  "./assets/img/logo-original.png?v=44",
  "./assets/img/logo-original-white.png?v=44",
  "./assets/img/logo.png?v=44",
  "./assets/img/wordmark-white.png?v=44",
  "./manifest.json"
];
