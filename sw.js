...
const PRECACHE = [
  ...
  "./assets/js/members-data.js?v=40",
  "./assets/js/news-data.js?v=40",
  "./assets/img/logo-original.png?v=40",
  "./assets/img/logo-original-white.png?v=40",
  "./assets/img/logo.png?v=40",
  "./assets/img/wordmark-white.png?v=40",
  "./manifest.json"
];
