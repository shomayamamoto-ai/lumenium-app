...
const PRECACHE = [
  ...
  "./assets/js/members-data.js?v=43",
  "./assets/js/news-data.js?v=43",
  "./assets/img/logo-original.png?v=43",
  "./assets/img/logo-original-white.png?v=43",
  "./assets/img/logo.png?v=43",
  "./assets/img/wordmark-white.png?v=43",
  "./manifest.json"
];
