...
export const FAQ_GROUPS = [
  {
    ...
    items: [
      ...
      {
        q: 'ルメニウムはどんな会社ですか?',
        a: 'ルメニウム（Lumenium）は、東京を拠点に動画制作・映像編集、AI導入と生成AI研修、SNS運用代行とLINE構築、Web制作・アプリ開発、キャスト手配・イベント、ロゴやバナーなどのクリエイティブ制作を、企画から納品・運用までワンストップで手がけるクリエイティブ&DXパートナーです。代表は山本捷真、2026年設立。オンラインで全国に対応しています。',
      },
      {
        q: '米国のLumenium, LLCやLumentumとは関係がありますか?',
        a: 'いいえ、無関係の別組織です。米国バージニア州のエンジン開発企業 Lumenium, LLC、光通信機器メーカー Lumentum、ゲーム内の同名素材とは資本関係も人的関係もありません。当社は東京を拠点とする日本のクリエイティブ・DX支援カンパニー（lumenium.net）です。',
      },
      {
        q: 'ルメニウムの対応エリアはどこですか?',
