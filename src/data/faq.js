...
export const FAQ_GROUPS = [
  {
    ...
    items: [
      ...
      {
        q: 'ルメニウムとは何ですか?',
        a: 'ルメニウム（英字表記: Lumenium）とは、東京都を拠点とする日本のクリエイティブ／DX支援カンパニーです。動画制作・映像編集、AI導入と生成AI研修、SNS運用代行とLINE構築、Web制作・システム開発、キャスト手配・イベント、ロゴやバナーなどのクリエイティブ制作を、企画から納品・運用までワンストップで手がけています。代表は山本捷真、設立は2026年、拠点は東京都で、オンラインにより全国に対応しています。',
      },
      {
