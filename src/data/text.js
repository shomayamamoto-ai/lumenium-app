// Section headings and lead copy, pulled out of the components so every
// sentence on the site is editable from the admin page.
...
export const SECTION = {
  ...
  home: {
    ...
    searchButton: '検索',
    askButton: 'AIに相談する',
    definition: 'ルメニウム（Lumenium）とは、東京都を拠点とする日本のクリエイティブ／DX支援カンパニーです。',
