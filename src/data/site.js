 ...
 *  ひとつです。自社サイトだけが情報源の会社は、答えるエンジンから見ると
 *  裏の取れない存在で、同じ社名・所在地・URLが外の面にも載っていて初めて
 *  「実在する」と扱われます。schema.org の sameAs は、その対応関係を機械に
 *  伝えるための項目で、全ページの会社情報に入ります。
 *
 *  入れるもの: X / Instagram / YouTube / Facebook / LinkedIn / note /
 *  法人番号公表サイト / 事業者ディレクトリ の、実在する公式ページだけ。
 *  持っていないものを書くと、そのURLを引いた先で矛盾が見つかり、
 *  かえって信用を下げます。 */
