      ...
      <div className="container">
        ...
        <div className="profile" data-animate data-delay="1">
          ...
          <div className="profile-body">
            ...
            <p className="profile-role">Lumenium（ルメニウム）代表</p>
        ...
        <div className="profile-bricks" data-animate data-delay="2" aria-label="活動領域">
          ...
          <article className="profile-brick">
            ...
            <p className="profile-brick-text">在学中から個人事業主として活動開始。マーケ・映像・AI開発を横断し、企業のAI導入コンサル、メディア運営 PM、ライター業を経て Lumenium（ルメニウム）を設立。</p>
            <ul className="profile-brick-list">
              <li>慶應義塾大学 文学部 卒業</li>
              <li>ビジネスコンテスト入賞多数</li>
